...
export const tokens = {
  ...
  typography: {
    ...
    scale: {
      ...
      "heading-h6": { fontSize: "20px", lineHeight: "140%", fontWeight: 500, letterSpacing: "-0.04em" },
      "body-x-large-bold": { fontSize: "18px", lineHeight: "150%", fontWeight: 700, letterSpacing: "-0.04em" },
      "body-x-large-semibold": { fontSize: "18px", lineHeight: "150%", fontWeight: 600, letterSpacing: "-0.04em" },
      "body-x-large-medium": { fontSize: "18px", lineHeight: "150%", fontWeight: 500, letterSpacing: "-0.04em" },
      "body-x-large-regular": { fontSize: "18px", lineHeight: "150%", fontWeight: 400, letterSpacing: "-0.04em" },
