...
export const tokens = {
  colors: {
    ...
    semantic: {
      ...
      content: {
        ...
        inverse: { light: primitives.gray[50], dark: primitives.gray[900] },
      },
      border: {
        primary: { light: primitives.gray[200], dark: primitives.gray[800] },
        secondary: { light: primitives.gray[300], dark: primitives.gray[700] },
        tertiary: { light: primitives.gray[400], dark: primitives.gray[600] },
      },
      feedback: {
  ...
  typography: {
    ...
    scale: {
      "display-s": { fontSize: "64px", lineHeight: "120%", fontWeight: 500, letterSpacing: "-0.02em" },
      ...
      "heading-h3": { fontSize: "40px", lineHeight: "120%", fontWeight: 500, letterSpacing: "-0.04em" },
      "heading-h4": { fontSize: "32px", lineHeight: "120%", fontWeight: 500, letterSpacing: "-0.04em" },
      "heading-h5": { fontSize: "24px", lineHeight: "120%", fontWeight: 500, letterSpacing: "-0.04em" },
      "heading-h6": { fontSize: "20px", lineHeight: "140%", fontWeight: 500, letterSpacing: "-0.02em" },
      "body-x-large-bold": { fontSize: "18px", lineHeight: "150%", fontWeight: 700, letterSpacing: "-0.02em" },
      "body-x-large-semibold": { fontSize: "18px", lineHeight: "150%", fontWeight: 600, letterSpacing: "-0.02em" },
      "body-x-large-medium": { fontSize: "18px", lineHeight: "150%", fontWeight: 500, letterSpacing: "-0.02em" },
      "body-x-large-regular": { fontSize: "18px", lineHeight: "150%", fontWeight: 400, letterSpacing: "-0.02em" },
      "body-large-bold": { fontSize: "16px", lineHeight: "150%", fontWeight: 700, letterSpacing: "-0.02em" },
      "body-large-semibold": { fontSize: "16px", lineHeight: "150%", fontWeight: 600, letterSpacing: "-0.02em" },
      "body-large-medium": { fontSize: "16px", lineHeight: "150%", fontWeight: 500, letterSpacing: "-0.02em" },
      "body-large-regular": { fontSize: "16px", lineHeight: "150%", fontWeight: 400, letterSpacing: "-0.02em" },
      "body-medium-bold": { fontSize: "14px", lineHeight: "150%", fontWeight: 700, letterSpacing: "-0.02em" },
      "body-medium-semibold": { fontSize: "14px", lineHeight: "150%", fontWeight: 600, letterSpacing: "-0.02em" },
      "body-medium-medium": { fontSize: "14px", lineHeight: "150%", fontWeight: 500, letterSpacing: "-0.02em" },
      "body-medium-regular": { fontSize: "14px", lineHeight: "150%", fontWeight: 400, letterSpacing: "-0.02em" },
      "body-small-bold": { fontSize: "12px", lineHeight: "150%", fontWeight: 700, letterSpacing: "-0.02em" },
      "body-small-semibold": { fontSize: "12px", lineHeight: "150%", fontWeight: 600, letterSpacing: "-0.02em" },
      "body-small-medium": { fontSize: "12px", lineHeight: "150%", fontWeight: 500, letterSpacing: "-0.02em" },
      "body-small-regular": { fontSize: "12px", lineHeight: "150%", fontWeight: 400, letterSpacing: "-0.02em" },
    },
  },
  spacing: {
    0: "0px",
