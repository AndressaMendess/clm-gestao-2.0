...
export default function StudentEditDocumentsPage() {
  ...
  return (
    <EditFlowShell
      ...
      onNext={() => router.push(`/students/${encodeURIComponent(decodedStudentId)}/edit/enrollment`)}
      onPrevious={() => router.push(`/students/${encodeURIComponent(decodedStudentId)}/edit/personal-data`)}
    >
        ...
        <section className="grid gap-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              <label className={requiredLabelStyles} htmlFor="edit-rg">
            ...
            <div className="grid gap-2">
              <label className={requiredLabelStyles} htmlFor="edit-cpf">
                CPF
              </label>
              <CpfInput
                id="edit-cpf"
