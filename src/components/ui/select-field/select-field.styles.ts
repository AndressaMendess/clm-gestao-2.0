...
const baseSelectTriggerStyles =
  "inline-flex min-h-11 w-full items-center justify-between gap-2 rounded-[10px] border bg-[var(--background-primary)] px-3 py-2 text-left text-[var(--content-primary)] [font-size:var(--typography-body-medium-regular-font-size)] [line-height:var(--typography-body-medium-regular-line-height)] [font-weight:var(--typography-body-medium-regular-font-weight)] [letter-spacing:var(--typography-body-medium-regular-letter-spacing)] [&>span]:block [&>span]:min-w-0 [&>span]:flex-1 [&>span]:truncate [&>span]:whitespace-nowrap outline-none transition-[border-color,box-shadow] duration-150 focus-visible:ring-2 focus-visible:ring-[var(--button-focus-ring)] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 data-[placeholder]:text-[var(--content-tertiary)]";
