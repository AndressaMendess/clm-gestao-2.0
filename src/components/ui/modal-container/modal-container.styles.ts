...
export const modalContainerStyles =
  "font-[var(--font-family-sans)] w-full max-w-[560px] overflow-hidden rounded-2xl border border-[var(--border-primary)] bg-[var(--background-primary)] shadow-[0_24px_56px_rgb(0_0_0_/_0.28)]";
...
export const modalContainerBodyStyles = "px-5 py-5 sm:px-6";

export const modalContainerFooterStyles =
