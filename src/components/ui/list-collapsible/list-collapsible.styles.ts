export const listCollapsibleRootStyles =
  "rounded-[24px] border border-[var(--border-primary)] bg-[var(--background-primary)] shadow-[0_6px_16px_rgb(0_0_0_/_0.05)]";

export const listCollapsibleHeaderStyles =
  "flex w-full items-start justify-between gap-3 px-5 py-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--button-focus-ring)] focus-visible:ring-offset-2";
...
export const listCollapsibleListStyles = "grid";

export const listCollapsibleItemStyles =
  "flex items-start justify-between gap-3 border-b border-[var(--border-primary)] py-3 last:border-b-0";
